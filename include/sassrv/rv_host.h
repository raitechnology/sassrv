...
#define _ADV_CLASS  "ADV_CLASS"
#define _ADV_SOURCE "ADV_SOURCE"
#define _ADV_NAME   "ADV_NAME"
#define _ADV_DESC   "ADV_DESC"
...
#define _HOST_STATUS "HOST.STATUS"
#define _HOST_START  "HOST.START"
#define _HOST_STOP   "HOST.STOP"

#define _LISTEN_START "LISTEN.START"
#define _LISTEN_STOP  "LISTEN.STOP"

#define _SESSION_START "SESSION.START"
#define _SESSION_STOP  "SESSION.STOP"

#define _UNREACHABLE_TRANSPORT   "UNREACHABLE.TRANSPORT"
#define _DATALOSS_OUTBOUND_BCAST "DATALOSS.OUTBOUND.BCAST"
#define _DATALOSS_INBOUND_BCAST  "DATALOSS.INBOUND.BCAST"

#define _RV_INFO_HOST_STATUS   _RV_INFO_SYSTEM "." _HOST_STATUS
#define _RV_INFO_HOST_START    _RV_INFO_SYSTEM "." _HOST_START
#define _RV_INFO_HOST_STOP     _RV_INFO_SYSTEM "." _HOST_STOP

#define _RV_INFO_LISTEN_START  _RV_INFO_SYSTEM "." _LISTEN_START
#define _RV_INFO_LISTEN_STOP   _RV_INFO_SYSTEM "." _LISTEN_STOP

#define _RV_INFO_SESSION_START _RV_INFO_SYSTEM "." _SESSION_START
#define _RV_INFO_SESSION_STOP  _RV_INFO_SYSTEM "." _SESSION_STOP

#define _RV_INFO_UNREACHABLE_TPORT   _RV_INFO_SYSTEM "." _UNREACHABLE_TRANSPORT

#define _RV_ERROR_DATALOSS_OUT_BCAST _RV_ERROR_SYSTEM "." _DATALOSS_OUTBOUND_BCAST
#define _RV_ERROR_DATALOSS_INB_BCAST _RV_ERROR_SYSTEM "." _DATALOSS_INBOUND_BCAST
